  ...
  if (view === "home")
    return (
      <div className="card">
        ...
        <p className="muted">This is your dashboard home.</p>
      </div>
    );
  if (view === "chats")
    return (
      <div className="card">
        <h3>Chats</h3>
        <p className="muted">Chat list coming soon.</p>
      </div>
    );
  if (view === "courses")
    return (
      <div className="card">
        <h3>Courses</h3>
        <p className="muted">Your courses will appear here.</p>
      </div>
    );
  if (view === "profile")
    return (
  ...
  if (view === "update")
    return (
      <div className="card">
        <h3>Update</h3>
        <p className="muted">
          Use the sidebar picture edit or profile update form.
        </p>
      </div>
    );
  return null;
...
export default function Home({ isSidebarOpen, toggleSidebar }) {
  ...
  const handleNavigate = (to) => {
    ...
    if (window.innerWidth <= 900 && typeof toggleSidebar === "function")
      toggleSidebar(false);
  };
      ...
      <main className="main">
        ...
        <div className="hero">
          <div className="lead">
            ...
            <p className="muted">
              Good to see you — manage your classes, chats and profile from
              here.
            </p>
          </div>
          <div className="cta">
